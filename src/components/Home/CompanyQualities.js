        ...
        >
          <Grid container>
            ...
            <Grid xs={9}>
              <Fade delay={400}>
                <Box my={2}>
                  <Typography variant="h4" css={qualityHeader}>
                    {title}
                  </Typography>
                </Box>
              </Fade>
        ...
        <Grid item xs={12} lg={4}>
          ...
          <Box css={heroImageHeadingContainer}>
            <Fade delay={200} duration={2500}>
              <Typography css={heroImageText}>WHY CHOOSE US</Typography>
            </Fade>
          </Box>
        </Grid>
        ...
        <Grid item xs={12} lg={8}>
          <Grid container css={qualityListContainer}>
            <Quality
              ...
              content={
                "Our core focus and strength is our quality with no compromise and zero tolerance."
              }
            />
            <Quality
              ...
              title="Optimum Price"
              content={
                "Our prices are quoted at most competitive price in the market."
              }
            />
            <Quality
              img="https://ucarecdn.com/d538cf5e-06f4-4ed2-a033-be331f868ca9/shelves.png"
              title="Wide Variety"
              content={"We manufacture a wide range of top quality oils and fragrances."}
            />
            <Quality
              img="https://ucarecdn.com/7d11b42a-0fb6-4a4e-b93f-cda83afb6e6b/customerreview.png"
              title="Customer Oriented"
              content={"We are always ready to provide support to all our customers. "}
            />
          </Grid>
        </Grid>
      </Grid>
